...
|---|---|---|
| Precision@5 | Ranking Accuracy | **0.0434** |
| Recall@5 | Coverage | **0.117** |
| NDCG@5 | Ranking Position Decay | **0.0792** |
| RMSE | Rating Prediction Error | **2.8064** |
| MAE | Absolute Error | **2.5917** |
